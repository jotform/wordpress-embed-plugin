...
Feedback button is a small button that shows up on the side of web pages. Usually with a "Feedback" or "Contact Us" text on it. When you click on the button a pop-up window launches with a form inside. Once you complete the form and submit the visitor and close the window and continue where he left off. 

= Why use a Feedback Button? =

Let's say one of your visitors saw a typo on your web site. They can contact you and let you know about it. Here is the problem. They have to stop what they are doing, go to your contact page, write a message, submit the form, and then they have to come back to the same page. Feedback buttons can be used without ever leaving the web page. They click on the button, enter their message, submit the form and continue their task. 
...
Yes, when you enable feedback button it will be shown on all of the pages on your site. The more coverage you have it is better. Your visitors will be able to report any problem to you quickly. 

= Will it Slow Down My Web Site? =

JotForm Feedback Button is actually a simply include for your JotForm feedback button. It is run on JotForm servers so it will never cause security or performance problems on your web site. 
